...
import { MdManageAccounts, MdConfirmationNumber, MdCampaign, MdAnalytics } from 'react-icons/md';
        ...
        >
            <List sx={{ width: '100%' }}>
                <ListItem disablePadding>
                    <ListItemButton component={NavLink} to='/admin-dashboard/profile' sx={{ ...navItemSx, py: 0.75 }}>
                        ...
                        <ListItemText primaryTypographyProps={{ fontSize: '0.9rem' }} primary='Profile' />
                    </ListItemButton>
                </ListItem>
                <ListItem disablePadding>
                ...
                <ListItem disablePadding>
                    <ListItemButton component={NavLink} to='/admin-dashboard/manage-tickets' sx={{ ...navItemSx, py: 0.75 }}>
                        <ListItemIcon sx={{ minWidth: 40 }}><MdConfirmationNumber size={20} style={{ color: theme.palette.mode === 'dark' ? '#818cf8' : 'inherit' }} /></ListItemIcon>
                        <ListItemText primaryTypographyProps={{ fontSize: '0.9rem' }} primary='Manage Tickets' />
                    </ListItemButton>
                </ListItem>
                <ListItem disablePadding>
